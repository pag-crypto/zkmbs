...
public class DNS_Amortized_doh_get extends CircuitGenerator {
  ...
  public DNS_Amortized_doh_get() {
    super("DNS_Amortized_doh_get");
    __generateCircuit();
  ...
  public void outsource() {
    ...
    UnsignedInteger[][] extraction_values = LabelExtraction.extractDoHGETReverse(dns_query);
