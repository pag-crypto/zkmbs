...
class HTTPTLSConnection(httplib.HTTPConnection, ClientHelper):
    ...
    def __init__(self, host, port=None, strict=None,
                ...
                anon=False,
                #ZOMBIE
                printhandshake = False, resumptionsession=None):
        ...
        self.printhandshake = printhandshake
        #ZOMBIE
        self.is_resumption_for_padding = not (resumptionsession is None)
    ...
    def connect(self):
        ...
        #ZOMBIE
        self.sock.method_flag_for_padding = "doh"
        self.sock.is_resumption_for_padding = self.is_resumption_for_padding
        self.sock.printHandshake = self.printhandshake
