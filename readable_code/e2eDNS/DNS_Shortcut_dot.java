Program DNS_Shortcut_dot { 
 
   
  public string channel_test_file_name = "test.txt"; 
  ...
  public void outsource() { 
    ...
    uint_8[][] extraction_values = LabelExtraction.extractDoTReverse(dns_query_bytes); 
    uint_8[] dns_labels = extraction_values[0]; 
     
    // This tests the membership in the merkle tree 
    uint_1 a; 
    a = non_membership.check_wildcard_python_path(dns_labels, root, left_domain_name, right_domain_name, left_index, right_index, left_path_array, right_path_array, left_dir, right_dir); 
